...
var inputFileName = "OrchardInputScript.txt";
// order of precedence for all characters in scene - 1st is highest priority
var charprecedence = ["ANYA", "YASHA", "EPIKHODOV", "TROFIMOV", "LOPAKHIN", "VARYA"];

// all marks, pawns, miscellaneous objects with their translated standardized value
var locationarray = ["CENTER", "BACK", "UPSTAGE", "DOWNSTAGE", "FORWARD", "BACKWARD", "STAGELEFT", "STAGERIGHT", "RIGHT", "CENTERBACKSTAGE", "AUDIENCE", "LEFT", "CENTERRIGHT", "OUT", "AWAY", "ARMS", "FRONT",  "AHEAD", "FORWARD",  "ROOM", "TRUNK", "BOX", "CHAIR", "TABLE", "ROOM", "DOOR", "HATBOX", "CENTERSTAGE"];
var translatedlocationarray = ["CENTER", "/BACK", "UPSTAGE", "DOWNSTAGE", "/FORWARD", "/BACK", "STAGELEFT", "STAGERIGHT", "/RIGHT", "CENTERBACKSTAGE", "AUDIENCE", "/LEFT", "CENTERRIGHT", "STAGERIGHT", "STAGERIGHT", "/CURRENT", "AUDIENCE", "AUDIENCE", "AUDIENCE", "/OPPOSITE", "TRUNK", "BOX", "CHAIR", "TABLE", "/OPPOSITE", "DOOR", "BOX", "CENTER"];

// all characters and pronouns with their translated standardized value
var chararray = [ "HE", "SHE", "HER", "WHO", "HIS", "ANYA", "YASHA", "EPIKHODOV", "TROFIMOV", "LOPAKHIN", "VARYA"];
var translatedchararray = [ "/CURRENT", "DOTTY", "/CURRENT", "/CURRENT", "/CURRENT", "ANYA", "YASHA", "EPIKHODOV", "TROFIMOV", "LOPAKHIN", "VARYA"];

// all physical locations on stage that person would need to move to, not relative position
var markarray = ["CHAIR", "TABLE"]; //NONE FOR THIS PLAY
...
// **************************************************************************************
	...
	var trunk = new Pawn('TRUNK', 1616.70, 1382.89, '0, 0, 0', '234, 234, 234', true);
	var box = new Pawn('BOX', 1522.25, 1382.89, '0, 0, 0', '234, 234, 234', true);
	...
	var anya = new Character('ANYA', 105.59, 1514.32, 0, '135,206,250', '0,0,128');
	var yasha = new Character('YASHA', 861.14, 1120.03, 0, '171,130,255', '85,26,139');
	...
	var defaultchar = anya;
	var defaulttarget = stageright;
	
	// all physical objects and people to be represented in the UI
	var mynames = ["ANYA", "YASHA", "EPIKHODOV", "TROFIMOV", "LOPAKHIN", "VARYA", "TRUNK", "BOX", "CHAIR", "TABLE"];
